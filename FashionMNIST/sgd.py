...
parser.add_argument('--logdir', default='logs/sgd', type=str)
...
if __name__ == '__main__':
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(args.maxiter):
            # training step
            mask = np.random.choice(train_set.n_examples, args.batch_size, False)
            data_tuple = (train_set.X[mask], train_set.Y[mask])
