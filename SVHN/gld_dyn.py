...
parser.add_argument('--logdir', type=str, default='logs/GLD_dyn')
...
for i in range(start_iter, args.maxiter):
    ...
    if i % args.update_noise == 0:
        ...
        _, diag2 = evalCovDiag(eval_list, model, criterion, optimizer)
    ...
    for param in model.parameters():
        ...
        param.grad.data += torch.randn(param.size()).cuda() * math.sqrt(diag2/n_param)
    optimizer.step()
